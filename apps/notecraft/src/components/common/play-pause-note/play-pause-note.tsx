...
export default function PlayPauseNote({ isPlaying, note }: Props) {
  return (
    <div className={styles.donut}>
      ...
      >
        <g transform='translate(110, 110)'>
          ...
          <circle
            r='100'
            className={cn(styles.donut__circle, styles['donut__circle--back'])}
          />
          {/* Loading State */}
          <circle
            r='100'
            className={cn(styles.donut__circle, styles['donut__circle--front'])}
          />

          {/* Middle Circle */}
          <circle r='70.5' fill='#A3A3A3' fill-opacity='0.15' />
        ...
        {/* Pause */}
        {isPlaying && (
          <g transform='translate(72.5, 75)' clip-path='url(#clip0_117_160)'>
            <path
